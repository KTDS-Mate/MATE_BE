...
public class SecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(httpRequest -> httpRequest
				...
				.requestMatchers("/api/v1/guidetour/late/review").permitAll()
				.requestMatchers("/api/v1/guidetour/reserve").permitAll()
				...
				.requestMatchers("/api/v1/guidetour/favorite/**").permitAll()
				.requestMatchers("/api/v1/guidetour/favorite/create").permitAll()
				.requestMatchers("/api/v1/guidetour/favorite/delete/**").permitAll()
