...
<body>
	<div class="grid">
		...
		<div class="content">
			<form:form id="insertPage" modelAttribute="guideTourWriteVO" method="post">
				<div class="insert-main">
					...
					<div class="all-select-div">
						<div class="select-div">
							<span class="red">*</span> 투어 제목
						</div>
						<form:errors path="gdTrTtl" element="div" cssClass="errors" />
						<input id="usrTrTtl" name="gdTrTtl" type="text"
							placeholder="제목을 입력해주세요." value="${guideTourWriteVO.gdTrTtl}" />
					</div>
					<div class="all-select-div">
						<div class="select-div">
						...
						</select> <select id="country" disabled>
							<option value="">국가 선택</option>
						</select> <select id="city" name="trCtId" disabled>
							<option value="">도시 선택</option>
						</select>
					</div>
					<div class="all-select-div">
						<div class="select-div">
							<span class="red">*</span> 날짜 선택
						</div>
						<input id="inputYear" name="inputYear" type="date"
							data-placeholder="투어 날짜를 골라주세요."
							value="${guideTourWriteVO.inputYear}" />
					</div>
					<div class="all-select-div">
						<div class="select-div">
							<span class="red">*</span> 시간 선택
						</div>
					...
					<div class="all-select-div">
						...
						<div class="person-flex-div">
							<input id="maxNp" type="number" name="gdTrMxNp"
					...
					<div class="all-select-div">
						<div class="select-div">
							<span class="red">*</span> 투어 세부 일정<span class="font-we">원하는
								일정을 추가해주세요.</span>
						</div>
						<div class="loc-inf">
						...
						<div class="hope-btn">
							<input id="plus" type="button" value="장소/일정 추가하기" /> <input
								id="m-btn" type="button" value="장소/일정 삭제하기" />
						</div>
					</div>
					<div class="all-select-div">
						<div>
							...
							<div class="hope-btn">
								<input id="info-plus" type="button" value="투어 정보 추가하기" /> <input
									id="info-m-btn" type="button" value="투어 정보 삭제하기" />
							</div>
						</div>
					</div>
					<div class="all-select-div">
						...
						<div class="hope-btn">
							<input id="incl-plus" type="button" value="투어 정보 추가하기" /> <input
								id="incl-m-btn" type="button" value="투어 정보 삭제하기" />
						</div>
					</div>
					<div class="all-select-div">
						<div class="inline">
					...
					<div class="all-select-div">
						<div class="price-submit-btn">
							...
							<div class="price-submit-btn-group">
								<div class="price-flex-div">
									<input id="trPrc" name="gdTrPrc" type="number"
										value="${guideTourWriteVO.gdTrPrc}" step="0.1" />
									<div>$</div>
								</div>
								<div class="button" onclick="javascript:insertGuideTour();">
