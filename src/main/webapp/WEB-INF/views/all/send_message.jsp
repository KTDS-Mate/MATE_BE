    ...
    <div class="content">
      <div class="content-grid">
        ...
        <div class="check-box-area">
          <img
            src="https://search.pstatic.net/sunny/?src=https%3A%2F%2Fpng.pngtree.com%2Fpng-vector%2F20190721%2Fourlarge%2Fpngtree-refresh-icon-for-your-project-png-image_1557315.jpg&type=sc960_832"
        ...
        <div class="border">
          <div class="message-box">
            <h2 class="text-send-message">보낸메세지</h2>
            <div class="menu-box">
              <div class="text-menu-message">
                <div class="text-select">선택</div>
                <div class="text-recieve">받는이</div>
