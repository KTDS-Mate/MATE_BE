<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <div class="my-page">
    <ul class="list">
      ...
      <li class="myapplytour"><a href="/mypage/tr-apply-tour/${sessionScope._LOGIN_USER_.usrLgnId}">나의 신청 투어</a></li>
      <li class="reveiw"><a href="/mypage/review/tr-guide/${sessionScope._LOGIN_USER_.usrLgnId}">나의 리뷰</a></li>
      <li class="payment"><a href="/mypage/payment/list/${sessionScope._LOGIN_USER_.usrLgnId}">결제 내역</a></li>
